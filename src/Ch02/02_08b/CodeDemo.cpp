// Learning C++ 
// Exercise 02_08 Запишем возраст 4 человек в массиве
...
int main(){
    ...
    age [2] = 19;
    age [3] = 19;
    //сначала мы указываем тип, затем название возраста массива, затем в [] емкость массива, у нас [4] по условию получается
    //теперь присваиваем значение каждому элементу в массиве

    //теперь выведем содержимое массива
